...
urdfModelTemplate = strrep(urdfModelTemplate,'RIGHTPINKY1RADIUS',num2str(subjectParams.rightPinky1_z/4));
urdfModelTemplate = strrep(urdfModelTemplate,'RIGHTPINKY2RADIUS',num2str(subjectParams.rightPinky2_z/4));
urdfModelTemplate = strrep(urdfModelTemplate,'RIGHTPINKY3RADIUS',num2str(subjectParams.rightPinky3_z/4));
...
urdfModelTemplate = strrep(urdfModelTemplate,'RIGHTRING1RADIUS',num2str(subjectParams.rightRing1_z/4));
urdfModelTemplate = strrep(urdfModelTemplate,'RIGHTRING2RADIUS',num2str(subjectParams.rightRing2_z/4));
urdfModelTemplate = strrep(urdfModelTemplate,'RIGHTRING3RADIUS',num2str(subjectParams.rightRing3_z/4));
...
urdfModelTemplate = strrep(urdfModelTemplate,'RIGHTMIDDLE1RADIUS',num2str(subjectParams.rightMiddle1_z/4));
urdfModelTemplate = strrep(urdfModelTemplate,'RIGHTMIDDLE2RADIUS',num2str(subjectParams.rightMiddle2_z/4));
urdfModelTemplate = strrep(urdfModelTemplate,'RIGHTMIDDLE3RADIUS',num2str(subjectParams.rightMiddle3_z/4));
...
urdfModelTemplate = strrep(urdfModelTemplate,'RIGHTINDEX1RADIUS',num2str(subjectParams.rightIndex1_z/4));
urdfModelTemplate = strrep(urdfModelTemplate,'RIGHTINDEX2RADIUS',num2str(subjectParams.rightIndex2_z/4));
urdfModelTemplate = strrep(urdfModelTemplate,'RIGHTINDEX3RADIUS',num2str(subjectParams.rightIndex3_z/4));
...
urdfModelTemplate = strrep(urdfModelTemplate,'RIGHTTHUMB1RADIUS',num2str(subjectParams.rightThumb1_z/4));
urdfModelTemplate = strrep(urdfModelTemplate,'RIGHTTHUMB2RADIUS',num2str(subjectParams.rightThumb2_z/4));
urdfModelTemplate = strrep(urdfModelTemplate,'RIGHTTHUMB3RADIUS',num2str(subjectParams.rightThumb3_z/4));
